...
public class EnlargePicture {
    public static void main(String[] args) {
        ...
        String[] resultValue = {"..xxxx......xxxx..", "..xxxx......xxxx..", "xx....xx..xx....xx", "xx....xx..xx....xx", "xx......xx......xx", "xx......xx......xx", "..xx..........xx..", "..xx..........xx..", "....xx......xx....", "....xx......xx....", "......xx..xx......", "......xx..xx......", "........xx........", "........xx........"};

        String[] solution = solution(picture, 2);
    ...
    public static String[] solution(String[] picture, int k) {
        ...
        for (int i = 0; i < picture.length; i++) {
            String scaledRow = stringScale(picture[i], k);
            for (int j = 0; j < k; j++) {
    ...
    public static String stringScale(String pixel, int k) {
        String result = "";
        for (char chr : pixel.toCharArray()) {
            for (int i = 0; i < k; i++) {
                result += chr + "";
            }
        }

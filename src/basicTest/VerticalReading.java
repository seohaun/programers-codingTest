...
/*
 ...
 입출력 예 설명
 - 입출력 예 #1 : 예제 1번의 my_string을 한 줄에 4 글자씩 쓰면 다음의 표와 같습니다.
    1열	2열	3열	4열
    i	h	r	h
    b	a	k	r
    f	p	n	d
...
public class VerticalReading {
    public static void main(String[] args) {
        ...
        String resultValue = "happy";

        String solution = solution(my_string, 4, 2);
    ...
    public static String solution(String my_string, int m, int c) {
        ...
        for (int i = 0; i < my_string.length() / m; i++) {
            for (int j = 0; j < m; j++) {
                if (j + 1 == c) answer.append(my_string.charAt(count));
                count++;
            }
        }

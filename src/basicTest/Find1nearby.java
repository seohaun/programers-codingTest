...
/*
 ...
 - [1, 1, 1, 1, 0]	    3	    3
 입출력 예 설명
 - 입출력 예 #1 : 1보다 크면서 원소가 1인 가장 작은 인덱스는 3입니다. 따라서 3을 return 합니다.
 - 입출력 예 #2 : 4번 인덱스 이후에 1은 등장하지 않습니다. 따라서 -1을 return 합니다.
 - 입출력 예 #3 : 3번 인덱스의 값이 1입니다. 따라서 3을 return 합니다.
 부가설명
 - idx 는 index 값. idx보다 크면서 <- 이 말은 arr[index]값과 비교하는게 아닌 arr배열의 index와 idx값을 비교해야함.
 */
public class Find1nearby {
    public static void main(String[] args) {
        int[] num_list = {0, 0, 0, 1};

        int solution = solution(num_list, 1);
        if (solution == 3) {
